...
var RoleGuard = class _RoleGuard {
  ...
  canActivate(route) {
    ...
    return this.authService.refreshProfile().pipe(map(() => !roles.length || this.authService.hasRole(roles) ? true : this.router.createUrlTree(["/"])), catchError(() => of(this.router.createUrlTree(["/auth/login"]))));
  }
  static {
    this.\u0275fac = function RoleGuard_Factory(t) {
      return new (t || _RoleGuard)(\u0275\u0275inject(AuthService), \u0275\u0275inject(Router));
    };
  }
  static {
...
function NavbarComponent_div_6_li_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 8)(1, "a", 15);
    \u0275\u0275text(2, "Users");
    \u0275\u0275elementEnd()();
  }
}
function NavbarComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 6)(1, "ul", 7)(2, "li", 8)(3, "a", 9);
    \u0275\u0275text(4, "Dashboard");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "li", 8)(6, "a", 10);
    \u0275\u0275text(7, "Documents");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "li", 8)(9, "a", 11);
    \u0275\u0275text(10, "Upload");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, NavbarComponent_div_6_li_11_Template, 3, 0, "li", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span", 13);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 14);
    \u0275\u0275listener("click", function NavbarComponent_div_6_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", user_r3.role === "admin");
    \u0275\u0275advance(2);
...
var NavbarComponent = class _NavbarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], decls: 7, vars: 1, consts: [[1, "navbar", "navbar-expand-lg", "navbar-dark", 2, "background", "var(--brand)"], [1, "container-fluid"], ["routerLink", "/", 1, "navbar-brand", "fw-bold"], ["type", "button", "data-bs-toggle", "collapse", "data-bs-target", "#mainNavbar", "aria-controls", "mainNavbar", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["class", "collapse navbar-collapse", "id", "mainNavbar", 4, "ngIf"], ["id", "mainNavbar", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "me-auto", "mb-2", "mb-lg-0"], [1, "nav-item"], ["routerLink", "/", 1, "nav-link"], ["routerLink", "/documents", 1, "nav-link"], ["routerLink", "/documents/upload", 1, "nav-link"], ["class", "nav-item", 4, "ngIf"], [1, "text-white", "me-3"], [1, "btn", "btn-outline-light", "btn-sm", 3, "click"], ["routerLink", "/admin/users", 1, "nav-link"]], template: function NavbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(5, "span", 4);
        \u0275\u0275elementEnd();
        \u0275\u0275template(6, NavbarComponent_div_6_Template, 16, 2, "div", 5);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(6);
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "page-container", "container-fluid"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var AuthInterceptor = class _AuthInterceptor {
  ...
  intercept(req, next) {
    ...
    return next.handle(authReq).pipe(catchError((error) => {
      ...
      const message = typeof error.error === "object" && error.error?.message || typeof error.error === "string" && error.error || error.message || "Request failed";
